    ...
    <div class="search-result">
      <el-scrollbar height="100%">
        <div class="search-result-snp20k common">
          <div class="title">
            SNP20K <span v-if="sortName">（{{ sortName }}）</span>
          </div>
          <div class="result-content">
            <div class="left">
              <div class="all-info" id="all-info">
                <div>
                  <span>有效位点数量/比列</span
                  ><span>{{ allInfo.validCount }}</span>
                </div>
                <div>
                  <span>Refer位点数量/比列</span
                  ><span>{{ allInfo.referCount }}</span>
                </div>
                <div>
                  <span>Alt位点数量/比列</span
                  ><span>{{ allInfo.altCount }}</span>
                </div>
                <div>
                  <span>杂合位点数量/比列</span
                  ><span>{{ allInfo.mixCount }}</span>
                </div>
              </div>
