                    ...
                    <div class="line_container">
                        <el-scrollbar>
                            <div style="display: flex;" v-if="status === '0'">
                                <div v-for="(list, i) in item.data" class="line_item"
                                    :class="[{ 'active_ref': list.name === 'REF' }, { 'active_alt': list.name === 'ALT' }, { 'active_het': list.name === 'HET' }]"
                                    :key="i" @mouseover="showLineDetail = i"></div>
                            </div>
                            <div style="display: flex;" v-if="status === '1'">
                                <div v-for="(list, i) in item.data" class="line_item"
                                    :class="[{ 'active_none': list.name === 'REF' || list.name === 'ALT' }, { 'active_dif': list.name === 'HET' }]"
                                    :key="i" @click="showCellDetail = true"></div>
                            </div>
                        </el-scrollbar>
                    </div>
                </div>
